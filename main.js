...
if(hb&&nl){
  hb.addEventListener('click',function(){
    ...
    if(mo){
      ...
      nl.style.right='0';
      nl.style.left='0';
      nl.style.background='#000';
      nl.style.padding='24px 28px';
      nl.style.gap='20px';
      nl.style.borderBottom='1px solid #1a1a1a';
      nl.style.zIndex='200';
...
function handleForm(e){
  ...
  fetch('https://parasyte-contact.infra-727.workers.dev',{
    ...
    if(res.ok){btn.textContent='MESSAGE SENT';btn.style.background='#00bfb5';form.reset();}
    else{btn.textContent='FAILED - TRY AGAIN';btn.style.background='#ff6414';}
  }).catch(function(){
